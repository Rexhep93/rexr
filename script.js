...
function crowHtml(item){
  ...
  if(item._type==='live'){
    ...
    if(hasEpInfo){
      ...
      /* Bepaal of dit een nieuw seizoen is:
         - Alle afleveringen in één keer gedropt (completeDrop)
         - OF alle afleveringen al uitgezonden (heel seizoen beschikbaar)
         - OF het is de eerste aflevering */
      var isNewSeason=isFirstEp||(completeDrop&&totalEps&&airedEps>=totalEps)||(totalEps&&airedEps>=totalEps);
      if(isNewSeason){
