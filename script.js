    ...
    '<div class="spin-stage" id="spinStage">'+
      '<div class="spin-idle">'+
        '<div class="spin-wheel-wrap"><div class="spin-wheel" id="spinWheel">'+
         '<svg width="160" height="160" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><g transform="translate(12 12)"><path d="M0 0L0-10A10 10 0 0 1 7.07-7.07Z" fill="#30af4c"/><path d="M0 0L0-10A10 10 0 0 1 7.07-7.07Z" fill="#7fdc9a" transform="rotate(45)"/><path d="M0 0L0-10A10 10 0 0 1 7.07-7.07Z" fill="#30af4c" transform="rotate(90)"/><path d="M0 0L0-10A10 10 0 0 1 7.07-7.07Z" fill="#7fdc9a" transform="rotate(135)"/><path d="M0 0L0-10A10 10 0 0 1 7.07-7.07Z" fill="#30af4c" transform="rotate(180)"/><path d="M0 0L0-10A10 10 0 0 1 7.07-7.07Z" fill="#7fdc9a" transform="rotate(225)"/><path d="M0 0L0-10A10 10 0 0 1 7.07-7.07Z" fill="#30af4c" transform="rotate(270)"/><path d="M0 0L0-10A10 10 0 0 1 7.07-7.07Z" fill="#7fdc9a" transform="rotate(315)"/></g><circle cx="12" cy="12" r="10" stroke="#1e6f34" stroke-width=".9"/><circle cx="12" cy="12" r="1.4" fill="#0b401a" stroke="#30af4c" stroke-width="1.5"/></svg>'+
        '</div></div>'+
