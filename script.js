...
function enrichMyListDates(callback){
  ...
  function isCompleteDrop(ep){return ep&&ep.airedEpisodes&&ep.seasonEpisodeCount&&ep.airedEpisodes>=ep.seasonEpisodeCount&&!ep.hasNextEpisode;}
