    ...
    '<div class="spin-stage" id="spinStage">'+
      '<div class="spin-idle">'+
        '<div class="spin-wheel-wrap"><div class="spin-wheel" id="spinWheel">'+
         '<svg width="160" height="160" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><defs><g id="tv" stroke="#000" stroke-width="0.4" stroke-linecap="round" stroke-linejoin="round" fill="none"><rect x="-1.3" y="-0.9" width="2.6" height="1.8" rx="0.25"/><line x1="-0.6" y1="-1.3" x2="0" y2="-0.9"/><line x1="0.6" y1="-1.3" x2="0" y2="-0.9"/></g><g id="camera" stroke="#000" stroke-width="0.4" stroke-linecap="round" stroke-linejoin="round" fill="none"><rect x="-0.9" y="-0.5" width="1.8" height="1"/><circle cx="-0.6" cy="-0.9" r="0.35"/><circle cx="0.2" cy="-0.9" r="0.35"/><rect x="0.9" y="-0.2" width="0.6" height="0.4"/></g></defs><g transform="translate(12 12)"><path d="M0 0 L0 -10 A10 10 0 0 1 7.07 -7.07 Z" fill="#30af4c"/><g transform="rotate(45)"><path d="M0 0 L0 -10 A10 10 0 0 1 7.07 -7.07 Z" fill="#7fdc9a"/></g><g transform="rotate(90)"><path d="M0 0 L0 -10 A10 10 0 0 1 7.07 -7.07 Z" fill="#30af4c"/></g><g transform="rotate(135)"><path d="M0 0 L0 -10 A10 10 0 0 1 7.07 -7.07 Z" fill="#7fdc9a"/></g><g transform="rotate(180)"><path d="M0 0 L0 -10 A10 10 0 0 1 7.07 -7.07 Z" fill="#30af4c"/></g><g transform="rotate(225)"><path d="M0 0 L0 -10 A10 10 0 0 1 7.07 -7.07 Z" fill="#7fdc9a"/></g><g transform="rotate(270)"><path d="M0 0 L0 -10 A10 10 0 0 1 7.07 -7.07 Z" fill="#30af4c"/></g><g transform="rotate(315)"><path d="M0 0 L0 -10 A10 10 0 0 1 7.07 -7.07 Z" fill="#7fdc9a"/></g><g transform="rotate(22.5) translate(0 -6.5) scale(0.6)"><use href="#tv"/></g><g transform="rotate(67.5) translate(0 -6.5) scale(0.6)"><use href="#camera"/></g><g transform="rotate(112.5) translate(0 -6.5) scale(0.6)"><use href="#tv"/></g><g transform="rotate(157.5) translate(0 -6.5) scale(0.6)"><use href="#camera"/></g><g transform="rotate(202.5) translate(0 -6.5) scale(0.6)"><use href="#tv"/></g><g transform="rotate(247.5) translate(0 -6.5) scale(0.6)"><use href="#camera"/></g><g transform="rotate(292.5) translate(0 -6.5) scale(0.6)"><use href="#tv"/></g><g transform="rotate(337.5) translate(0 -6.5) scale(0.6)"><use href="#camera"/></g></g><circle cx="12" cy="12" r="10" stroke="#1e6f34" stroke-width="0.9"/><circle cx="12" cy="12" r="1.4" fill="#0b401a" stroke="#30af4c" stroke-width="1.5"/></svg>'+
        '</div></div>'+
