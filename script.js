    ...
    '<div class="spin-stage" id="spinStage">'+
      '<div class="spin-idle">'+
        '<div class="spin-wheel-wrap"><div class="spin-wheel" id="spinWheel">'+
         '<svg width="160" height="160" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><defs><filter id="f" x="-20%" y="-20%" width="140%" height="140%"><feDropShadow dy=".5" stdDeviation=".4" flood-color="#0a2e12" flood-opacity=".35"/></filter><clipPath id="c"><circle cx="12" cy="12" r="8.5"/></clipPath></defs><circle cx="12" cy="12" r="11.5" fill="#0b401a"/><circle cx="12" cy="12" r="10.8" fill="#145c28"/><g clip-path="url(#c)"><g transform="translate(12 12)"><path d="M0 0L0-9A9 9 0 0 1 6.36-6.36Z" fill="#2da547"/><path d="M0 0L0-9A9 9 0 0 1 6.36-6.36Z" fill="#6dd692" transform="rotate(45)"/><path d="M0 0L0-9A9 9 0 0 1 6.36-6.36Z" fill="#249940" transform="rotate(90)"/><path d="M0 0L0-9A9 9 0 0 1 6.36-6.36Z" fill="#7fdc9a" transform="rotate(135)"/><path d="M0 0L0-9A9 9 0 0 1 6.36-6.36Z" fill="#2da547" transform="rotate(180)"/><path d="M0 0L0-9A9 9 0 0 1 6.36-6.36Z" fill="#6dd692" transform="rotate(225)"/><path d="M0 0L0-9A9 9 0 0 1 6.36-6.36Z" fill="#249940" transform="rotate(270)"/><path d="M0 0L0-9A9 9 0 0 1 6.36-6.36Z" fill="#7fdc9a" transform="rotate(315)"/></g></g><circle cx="12" cy="12" r="8.5" fill="none" stroke="#0f5422" stroke-width=".3"/><g transform="translate(12 12)"><circle cx="9.7" cy="0" r=".55" fill="#ffe14d"/><circle cx="6.86" cy="6.86" r=".55" fill="#ffc107"/><circle cx="0" cy="9.7" r=".55" fill="#ffe14d"/><circle cx="-6.86" cy="6.86" r=".55" fill="#ffc107"/><circle cx="-9.7" cy="0" r=".55" fill="#ffe14d"/><circle cx="-6.86" cy="-6.86" r=".55" fill="#ffc107"/><circle cx="0" cy="-9.7" r=".55" fill="#ffe14d"/><circle cx="6.86" cy="-6.86" r=".55" fill="#ffc107"/><circle cx="8.95" cy="3.71" r=".45" fill="#ffe14d"/><circle cx="3.71" cy="8.95" r=".45" fill="#ffc107"/><circle cx="-3.71" cy="8.95" r=".45" fill="#ffe14d"/><circle cx="-8.95" cy="3.71" r=".45" fill="#ffc107"/><circle cx="-8.95" cy="-3.71" r=".45" fill="#ffe14d"/><circle cx="-3.71" cy="-8.95" r=".45" fill="#ffc107"/><circle cx="3.71" cy="-8.95" r=".45" fill="#ffe14d"/><circle cx="8.95" cy="-3.71" r=".45" fill="#ffc107"/></g><g filter="url(#f)"><polygon points="12,0 10.3,2.6 13.7,2.6" fill="#0b401a" stroke="#2da547" stroke-width=".35" stroke-linejoin="round"/></g><circle cx="12" cy="12" r="2.2" fill="#0f5422" stroke="#1a7a32" stroke-width=".4"/><circle cx="12" cy="12" r="1.4" fill="#0b401a" stroke="#2da547" stroke-width=".5"/><circle cx="12" cy="12" r=".7" fill="#2da547"/></svg>'+
        '</div></div>'+
