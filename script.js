...
function buildDateTabs(){
  ...
  /* Swipe hint bar (separate element after date tabs) */
...
function setType(f){
  ...
  if(f==='stream'){streamType='all';streamSubFilter=null;svcBarVisible=false;dt.style.display='';if(sh)sh.style.display='';sb.style.display='none';fb.style.display='';updateSvcClearFloat();buildFilterChips();renderMain();}
